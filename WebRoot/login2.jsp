...
content="keyword1,keyword2,keyword3">
  ...
  <body style="background-image:url(picture/background.jpg); background-size:cover;">
  <br/>

 <div  align="center" class="center">
     <h2 align="center" style="background-color:rgba(255, 255, 255, 0.5);" >学生毕业设计管理系统</h2> 
 
    <form action="login.action" method="post" >
    <table  style="background-color:rgba(255, 255, 255, 0.5);line-height:30px; border-collapse:separate; " cellspacing="20px" >
