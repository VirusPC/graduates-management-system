  ...
  <jsp:include page="teacher_menu.jsp"></jsp:include>
    	<from>
    		<table align="center" width="110">
    			<tr><td><textarea cols="70" rows="15" readonly="readonly"><s:iterator value="#session.projects.list" var="pro"><s:if test="#pro.pid==#parameters.pid[0]"><s:property value="#pro.pdesc"/></s:if></s:iterator>
				</textarea></td></tr>
    		</table>
    	</from>
  </body>
