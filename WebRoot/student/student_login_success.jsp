...
<div style="float:left">
  	...
  	<s:iterator value="#session.bulletin.list" var="bu"><li> <a id="bu" href="student/student_login_success.jsp?bid=<s:property value="#bu.bid"/>"/><s:property value="#bu.bname"/></a></br>&nbsp; </li></s:iterator>
   
   	
   					<s:if test="#session.bulletin.totalPage>1">				
				<li style="display:inline"><a
					href="student/student_queryBulletinByStudentId.action?currentPage=1">首页</a></li>&nbsp;				
				<s:if test="#session.bulletin.currentPage!=1">
				<li style="display:inline"><a
					href="student/student_queryBulletinByStudentId.action?currentPage=<s:property value="#session.bulletin.currentPage-1"/>">&laquo;</a></li>&nbsp;
				</s:if>
				<%
				...
				%>
				<li style="display:inline"><a
					href="student/student_queryBulletinByStudentId.action?currentPage=<%=i%>"><%=i%></a></li>&nbsp;
				<%
					}
				%>
				<s:if test="#session.bulletin.currentPage!=#session.bulletin.totalPage">
				<li style="display:inline"><a
					href="student/student_queryBulletinByStudentId.action?currentPage=<s:property value="#session.bulletin.currentPage+1"/>">&raquo;</a></li>
				</s:if>
				<li style="display:inline"><a
					href="student/student_queryBulletinByStudentId.action?currentPage=<s:property value="#session.bulletin.totalPage"/>">尾页</a></li>&nbsp;
			</s:if>
